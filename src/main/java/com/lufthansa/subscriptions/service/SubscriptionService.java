...
public class SubscriptionService extends BaseService<Subscription> {
    ...
    public List<Subscription> findByStatusAndCurrentPeriodEndBefore(SubscriptionStatus status,
                                                             LocalDate date){
    ...
    public SubscriptionService(SubscriptionRepository subscriptionRepository, CustomerService customerService,
                               SubscriptionPlanService subscriptionPlanService, InvoiceService invoiceService) {
    ...
    public Subscription createSubscription(SubscriptionDto subscriptionDto) {
        Customer customer = customerService.findById(subscriptionDto.getCustomer().getId(), Customer.class.getSimpleName());
