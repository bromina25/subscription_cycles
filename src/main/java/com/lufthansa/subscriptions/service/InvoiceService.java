...
public class InvoiceService extends BaseService<Invoice> {
    ...
    public Page<InvoiceDto> getInvoices(Long customerId, InvoiceStatus status, LocalDate dateFrom, LocalDate dateTo,
                                        int page, int size) {
        Pageable pageable = PageRequest.of(page, size, Sort.by("id").descending());
        Page<Invoice> invoices = invoiceRepository.findInvoices(customerId, status, dateFrom, dateTo, pageable);
